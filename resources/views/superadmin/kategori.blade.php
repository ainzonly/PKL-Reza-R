                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($varKat as $item)
                                        <tr>
                                            <td> {{ $item->namakategori }} </td>

                                            <td> <a class="btn btn-warning"  href="{{ url('ubah-kategori/'.$item->id) }}">Ubah</a> | <a class=" btn btn-danger"href="{{ url('hapus-kategori/'.$item->id) }}">Hapus</a> </td>
                                        </tr>
                                    @endforeach
